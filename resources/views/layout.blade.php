			...
			<div class="relative z-20">
				...
				<div class="hidden md:flex md:flex-1 md:items-center md:justify-between">
					<nav class="flex space-x-10">
						<a href="#" class="text-base font-medium text-gray-500 hover:text-gray-900">Add team member</a>
						<a href="#" class="text-base font-medium text-gray-500 hover:text-gray-900">Add team</a>
						<a href="#" class="text-base font-medium text-gray-500 hover:text-gray-900">Submit</a>
					</nav>
			...
			<div x-show="menuOpen" x-transition class="absolute inset-x-0 top-0 z-30 origin-top-right transform p-2 transition md:hidden">
				...
				<div class="py-6 px-5">
					<div class="grid grid-cols-1 gap-4">
						<a href="/add-team-member" class="rounded-md text-base font-medium text-gray-900 hover:text-gray-700">Add team member</a>
						<a href="/add-team" class="rounded-md text-base font-medium text-gray-900 hover:text-gray-700">Add team</a>
						<a href="/data" class="rounded-md text-base font-medium text-gray-900 hover:text-gray-700">Add data</a>
					</div>
					<div class="mt-6">
